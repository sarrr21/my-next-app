      ...
      <section className="relative bg-gradient-to-br from-primary/5 to-secondary/5 py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8 leading-relaxed font-sans">
            "Alone, one can only do so much — but together, we can do so much
            more." Unity multiplies impact.
          </p>
        </div>
      </section>
        ...
        <div className="bg-white shadow-xl rounded-2xl overflow-hidden grid md:grid-cols-2">
          ...
          <form onSubmit={handleSubmit} className="p-10 space-y-6 bg-white">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold py-3 rounded-xl shadow-lg hover:from-orange-600 hover:to-orange-700 transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-orange-300 disabled:opacity-50"
            >
