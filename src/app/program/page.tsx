    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
        ...
        <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Collaboration with global organizations (UNICEF, WHO, USIDHR, etc.) and community development projects
            both in the USA, Africa.
          </p>
          <Link href="/donate">
            <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white px-6 sm:px-8 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg font-medium transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/30">
              DONATE NOW
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
        ...
        <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Our empowerment initiatives support vulnerable populations through education, legal aid, and economic
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
        ...
        <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            We improve community health by providing reproductive health education, sanitary products, and support
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
        ...
        <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            TLGEF is deeply committed to empowering women and girls by providing mentorship, leadership development,
