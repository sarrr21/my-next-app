...
import { FacebookIcon, Instagram, Linkedin, Twitter, TwitterIcon, X } from "lucide-react"
...
export default function FooterSection() {
  ...
  {[
    { icon: FacebookIcon, bg: "bg-blue-600 hover:bg-blue-700", href: "https://www.facebook.com/share/176NAyHkqB/?mibextid=wwXIfr" },
    { icon: TwitterIcon, bg: "bg-black hover:bg-gray-800", href: "https://x.com/tausilikokola/status/1959981593755316241?s=46&t=kJNbMnaGSnnx0qJ8CxvNgg" },
    { icon: Linkedin, bg: "bg-blue-700 hover:bg-blue-800", href: "https://linkedin.com/in/yourprofile" },
    { icon: Instagram, bg: "bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 hover:opacity-90", href: "https://www.instagram.com/tausilikokolaglobalfoundation?igsh=MXB6YWt5cjJ2bnN1cg%3D%3D&utm_source=qr" },
